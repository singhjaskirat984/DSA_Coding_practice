...
/*
in java 
i++ is equals to i=i+1
but i+=1 is not equal to i=i+1
The i+=1 operator includes a implicit type cast.
that is it is equal to i = (int)(i + l); 
therefore this [i += p * Math.pow(10, dig - 1);] is equal to [i = (int) (i + p*Math.pow(10, rem-1));]
*/
